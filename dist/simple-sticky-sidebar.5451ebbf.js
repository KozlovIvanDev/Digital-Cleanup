...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/simple-sticky-sidebar.js":[function(require,module,exports) {
/* ========================================================================
...
function simpleStickySidebar(element, options) {
  ...
  window.addEventListener('scroll', function (event) {
    var scrollTop = window.scrollY; // when scroll position touch the "Sidebar"
    ...
    if (scrollTop > stickyOffsetTop - topSpace) {
      ...
      if (getStickyHeight() <= $window.innerHeight - topSpace) {
        ...
        if (scrollTop > lastScrollVal) {
          ...
          var absoluteStickyOffsetTop = getOffset(sticky).top; //  if "Sidebar" fixed from bottom, stop sticky to its position
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/simple-sticky-sidebar.js"], null)
//# sourceMappingURL=/simple-sticky-sidebar.5451ebbf.js.map